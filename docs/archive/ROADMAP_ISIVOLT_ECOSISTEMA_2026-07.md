# Roadmap histórico: ecosistema IsiVolt

> Archivado en julio de 2026. Este documento conserva la visión anterior para trazabilidad, pero ya no es el documento rector. Consultar `docs/MASTER_PLAN_ISIVOLTPRO.md`.
...
### Prioridades inmediatas históricas
...
## Prioridad histórica de desarrollo
